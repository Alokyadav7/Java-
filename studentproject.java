...
import javax.swing.*;
    ...
    class OnlineTest extends JFrame implements ActionListener
    {
        ...
        void set()
        {
            ...
            if(current==0)
            {
                l.setText("Que1: Who is the best footballer in the world?");
                jb[0].setText("Messi");jb[1].setText("Neymar");jb[2].setText("Ronaldo");jb[3].setText("Gavi");
            }
            if(current==1)
            {
                l.setText("Que2: Who have the most ballon dor in the world og the football?");
